...
public class PlanetSet : MonoBehaviour
{
	...
	void Awake ()
	{
        ...
        planetParameters[8] = new float[numOfPlanetParams]{
            ...
            //eccentricity, r_pericenter, orbital period轨道周期, radius半径, axial tilt转轴倾斜角, rot period, longtitude of ascending node 升交点黄经, mass
            0.967f,
            0.59f*scaleRp,
            76f,
            93.2115f, //3.9f,?????
        ...
        switch (gameObject.name)
        {
            ...
            case "Halley": SetPlanet(planetNames[8], planetParameters[8]); break;
